...
|---|---:|---:|---:|---:|---:|
| Small complete (24 new) | 0.452 | 1.529 | 0.543 | 1.587 | 0.200 |
| Large SCC (192 new) | 26.935 | 28.808 | 37.179 | 40.766 | 20.103 |
| History update (480 old + 8 new) | 17.858 | 42.058 | 17.686 | 23.408 | 43.105 |

![计算阶段](computation-stages.png)

| 工作负载 | 配对 Verify/Build 中位数 [min, max] | 新图节点/边/最大 SCC | 旧图数/旧交易 | 更新边/释放交易 |
|---|---:|---:|---:|---:|
| mechanism_small | 1.043 [1.011, 1.156] | 24/276/1 | 0/0 | 0/24 |
| mechanism_cycle | 1.411 [1.193, 1.444] | 192/18336/192 | 0/0 | 0/192 |
| mechanism_update | 0.557 [0.536, 0.570] | 8/28/1 | 4/480 | 1/488 |
